...
public class Obstacle : MonoBehaviour
{
    ...
    private void Start()
    {
        float randomValX = Random.Range(-1f, 1f);
        float randomValY = Random.Range(-1f, 1f);
        
        directionToMove = new Vector2(randomValX, randomValY).normalized;
    ...
    public void SplitOrDestroy()
    {
        ...
        else
        {
            ...
            obstaclePooler.RemoveObstacles(this);
    ...
    private void Split()
    {
        ...
        Obstacle obstacle = obstaclePooler.SpawnFromPool(PoolType.Obstacle, transform.position + Vector3.right * 0.5f,
            Quaternion.identity);
        obstaclePooler.AddObstacles(obstacle);
